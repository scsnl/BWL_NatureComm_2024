function [StatePP_GroupStat, StatePP_SubjStat, StatePP_everyTrial]=func_statePPproperties(onsetNoffset, grpStatePP, num)
    ...
    for subj = 1:num.Subj
        for run = 1:num.Run
            ...
            for m = 1:size(isubj_onsetNoffset,1)
                ...
                moffset_R = isubj_onsetNoffset.Respons_Off(m);
